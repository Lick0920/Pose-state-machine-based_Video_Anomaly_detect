...
from args_s4_vibe import create_exp_dirs
from args_s4_vibe import init_parser, init_sub_args
from dataset_vibe import get_dataset_and_loader
...
def main():
    ...
    dataset, loader = get_dataset_and_loader(args, trans_list=None, only_test=(pretrained is not None))

    ### 20 pred 4   10 pred 2  40 --> 8
    input_frame = 20  # dmodel = 64 
    model = ViS4mer(d_input=72, l_max=input_frame, d_output=(args.seg_len - input_frame)*72, d_model=64, n_layers=3, seg_len = args.seg_len)
