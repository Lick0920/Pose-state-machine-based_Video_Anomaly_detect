...
def init_sub_args(args):
    ...
    if args.vid_path_train and args.vid_path_test and args.pose_path_train and args.pose_path_test:
        ...
        args.pose_path = {'train': os.path.join(args.data_dir, dataset, 'pose_supervise_split', 'train_labeled/'),
                          'test':  os.path.join(args.data_dir, dataset, 'pose_supervise_split', 'test_labeled/')}
...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_s4_splitshanghai/'):
    ...
    parser.add_argument('--num_workers', type=int, default=1, metavar='W', help='number of dataloader workers (0=current thread) (default: 32)')
    ...
    parser.add_argument('--seg_len', type=int, 
                        default=24, metavar='SGLEN', help='Number of frames for training segment sliding window, a multiply of 6 (default: 12)')
    ...
    parser.add_argument('--checkpoint', type=str,
                        # default = "data\exp_dir_state\ShanghaiTech\Aug09_2224_s4_30_4_5e5\\0_ep_Aug09_2226__checkpoint.pth.tar", 
                        # default= "data\exp_dir_s4_splitshanghai\\ShanghaiTech\Aug26_0959_10(l+dis)\\0_ep_Aug26_0959__checkpoint.pth.tar",
                        # default = "data\\exp_dir_s4_splitshanghai\\ShanghaiTech\\Aug26_0933_100(l+dis)\\0_ep_Aug26_0934__checkpoint.pth.tar", 
                        # default= "data\\exp_dir_s4_splitshanghai\\ShanghaiTech\\Sep02_2009\\0_ep_Sep02_2011__checkpoint.pth.tar",
                        # default= "data\\exp_dir_s4_splitshanghai\\ShanghaiTech\\Sep02_1958\\0_ep_Sep02_1959__checkpoint.pth.tar",
                        default = None,
                        # default= "data\exp_dir_state\ShanghaiTech\Aug09_2257_t4_30_4_5e5\\0_ep_Aug09_2259__checkpoint.pth.tar",
