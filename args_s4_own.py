...
def init_sub_args(args):
    ...
    args.vid_path = {'train': None,
                        'test':  None}

    args.pose_path = {'train': "F:\\dataset_anomaly230906\\data_output\\train_walk_small_hrnetpose",
...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_s4_ownpose/'):
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        # default = None,
                        default= "data\\exp_dir_s4_ownpose\\ShanghaiTech\\Sep16_1450\\0_ep_Sep16_1450__checkpoint.pth.tar",
                        metavar='model', help="Path to a pretrained model")
    parser.add_argument('--batch_size', type=int, default=128,  metavar='B', help='Batch size for train')
