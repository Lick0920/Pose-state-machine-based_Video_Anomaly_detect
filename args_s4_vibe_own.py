...
def init_sub_args(args):
    ...
    # args.pose_path = {'train': "F:\\dataset_anomaly230906\\data_output\\train_walk_small_vibepose_rename",
    #                     'test':  "F:/dataset_anomaly230906/data_output/test_cls_hrnetpose/test_walk_fight_snachers"}
    args.pose_path = {'train': "F:\\dataset_anomaly230906\\data_output\\train_walk_small_vibepose",
                        'test':  "F:\dataset_anomaly230906\data_output\single_test\pose_list"}
...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_s4_vibe_own/'):
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        default= "data\exp_dir_s4_vibe_own\\ShanghaiTech\\Sep16_1945\\0_ep_Sep16_1945__checkpoint.pth.tar",
                        # default = None,
                        # default= "data\\exp_dir_s4_vibe\\ShanghaiTech\\Sep16_1531\\0_ep_Sep16_1532__checkpoint.pth.tar",
