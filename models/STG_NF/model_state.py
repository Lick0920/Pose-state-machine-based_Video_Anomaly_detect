    ...
    def __init__(
        ...
        for _ in range(n_layers):
            if self.layer_type == 's4':
                ...
                self.s4_layers.append(
                    TransformerLayer(d_model=d_model, num_heads=8, dff=l_max, dropout_rate=0.1)
                )
...
if __name__ == "__main__":
    ...
    d_output = 36
    l_max = 23
    model = ViS4mer(d_input=d_input, l_max=l_max, d_output=d_output, d_model=64, n_layers=3, layer_type='transformer')
