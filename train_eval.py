...
from dataset_ws import get_dataset_and_loader
...
def main():
    ...
    # args.seg_len = 16
    # args.R = 10
    # args.pose_path_train_abnormal = ""data\\UBnormal\\pose\\abnormal_train""
    # # args.checkpoint = 'checkpoints/UBnormal_supervised_79_2.tar'
    ...
    from utils_r.scoring_utils import get_dataset_scores
