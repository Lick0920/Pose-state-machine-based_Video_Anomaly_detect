...
from utils_r.data_utils_own import normalize_pose
from utils_r.pose_utils_own import gen_clip_seg_data_np, get_ab_labels
...
def gen_dataset(person_json_root, num_clips=None, kp18_format=True, ret_keys=False, ret_global_data=True,
    ...
    json_list = sorted([fn for fn in dir_list if fn.endswith('_yolo_bbox_hrnet_pose.json')])
