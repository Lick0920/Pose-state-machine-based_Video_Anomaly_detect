...
def init_sub_args(args):
    ...
    args.pose_path = {'train': os.path.join(args.data_dir, "VIBE_shanghai", 'vibepose', 'train/'),
                        'test':  os.path.join(args.data_dir, "VIBE_shanghai", 'vibepose', 'test/')}
...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_s4_vibe/'):
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        # default= "data\exp_dir_s4_vibe\\ShanghaiTech\\Sep16_1330\\0_ep_Sep16_1331__checkpoint.pth.tar",
                        # default = None,
